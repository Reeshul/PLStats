...
import { makeStyles, SvgIcon, Grid } from "@material-ui/core";
...
const Logo = () => {
  ...
  return (
    <Grid className={classes.logo}>
      <SvgIcon viewBox="0 0 131.1 166.7" color="secondary">
        <path
          d="M28.8,18.8c6.8,3.2,11.3,7.1,12.1,7.7c-0.3-1.8-1.7-10.3-2.6-15.5c3.9,2.7,13.3,9.2,16.3,11.3
                ...
                C115.1,92.7,114.3,84,111.3,76.7z"
        ></path>
      </SvgIcon>
    </Grid>
  );
